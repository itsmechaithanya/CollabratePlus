    ...
    <div className='bg-black text-white h-fit w-full overflow-hidden'>
      ...
      <div className='flex justify-between items-center px-[8vh]'>
        <div className=' h-[60vh] w-full flex justify-between items-center'>
          <div className=''>
            <h1 className='text-[#A3A3A3] text-[3vh] ml-[.5vw]'>Collabrate +</h1>
            <h1 className=' capitalize text-[7vh] font-semibold leading-[8.3vh] mt-[1vh]'>good things <br /> will happen <br /> when you say <br /> “hello!”</h1>
          </div>
        </div>
        <div className=' h-[60vh] flex flex-col justify-between py-[15vh] pr-[5vw]'>
          <div className=' text-[4vh] text-[#A3A3A3]'><h1>We would love to <br /> connect on LinkedIn</h1></div>
          <div>
            <h1 className='text-[#A3A3A3]'>Designed and developed by</h1>
            <div className='flex text-[#A3A3A3] gap-[2vw] text-[3vh] mt-[2vh]'>
              <div className=''>
                <h1><i class="ri-arrow-right-up-line text-white"></i>Chiathanya</h1>
                <h1><i class="ri-arrow-right-up-line text-white"></i>Vignesh</h1>
              </div>
              <div>
                <h1><i class="ri-arrow-right-up-line text-white"></i>Thanmayi</h1>
                <h1><i class="ri-arrow-right-up-line text-white"></i>Abhiram</h1>
              </div>
            </div>
          </div>
        </div>
