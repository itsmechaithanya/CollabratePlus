...
function Welcome() {
  return (
    ...
    <Link to="/designation" className='px-[2vw] py-[1vh] border absolute top-[20vh] right-[5vw] z-10 rounded-[5vh] bg-white'>Continue <i className="ri-arrow-right-long-line"></i></Link>
    </div>
  )
}
